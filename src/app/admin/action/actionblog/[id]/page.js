...
const Page = ({ params }) => {
  ...
  const linkTwo = `${process.env.NEXT_PUBLIC_FRONTEND_LINK}/admin/action/${nameTwo}`;
  const nameThree = blogPostData.title;
  const linkThree = `${process.env.NEXT_PUBLIC_FRONTEND_LINK}/admin/action/actionblog/${blogPostData.slug}`;
