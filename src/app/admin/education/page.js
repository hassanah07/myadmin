...
const Page = ({ searchParams }) => {
  ...
  const fetchData = async () => {
    const url = `${process.env.NEXT_PUBLIC_HOST}/api/blogpost/education?currentpage=${currentPage}&datalimit=${dataLimit}`;
  ...
  const nameThree = "Education";
  const linkThree = `${process.env.NEXT_PUBLIC_FRONTEND_LINK}/admin/education`;
